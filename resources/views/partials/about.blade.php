<div class="columns has-text-centered">
    ...
    <div class="column">
        ...
        <p class="has-text-centered">The templates are bought from <i>Brazil</i>, where nowadays 1 dollar is worth 3
            dollars. So basically here you have 3 times more money! <strong>That is why the templates are so
                cheap</strong>.</p>
    ...
    <div class="column">
        ...
        <p class="has-text-centered">All payments are handled through <i>Paypal</i>, so you can be sure
            that <strong>your money will be safe </strong>during
...
<div class="columns has-text-centered" style="margin-bottom: 2em">
    ...
    <div class="column">
        ...
        <p class="has-text-centered">Unfortunately we <strong>cannot provide support</strong> due to the huge amount of
            templates we are offering. For the time being we don't have any solution for you in case
            you need support for modifying or extending a template.</p>
    ...
    <div class="column">
        ...
        <p class="has-text-centered">If the template you bought did not work properly <strong>we will give you a
            refund</strong> if you warns us about the problem within 2 business days after the purchase.</p>
